...
/*!*****************************!*\
  !*** ./employees/server.js ***!
  \*****************************/
/*! exports provided: getEmployees, addEmployee, setEmployeeManager, removeEmployee */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const employeesServer = axios__WEBPACK_IMPORTED_MODULE_0___default.a.create(
...
async function addEmployee(name, surname,
                                  managerId = null) {
...
async function setEmployeeManager(id, managerId) {
...
/*!******************************!*\
  !*** ./employees/service.js ***!
  \******************************/
/*! exports provided: addEmployee, removeEmployee, findById, setEmployeeManager */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!***********************************!*\
  !*** ./employees/service.pure.js ***!
  \***********************************/
/*! exports provided: removeEmployee, addEmployee, setEmployeeManager */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addEmployee", function() { return addEmployee; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setEmployeeManager", function() { return setEmployeeManager; });
/* harmony import */ var _model_Employee__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/Employee */ "./employees/model/Employee.js");
...
function addEmployee(employees, name, surname) {
    ...
    return [...employees, new _model_Employee__WEBPACK_IMPORTED_MODULE_0__["Employee"](name,surname,id)];
}
...
function setEmployeeManager(employees, id, managerId){
    let newEmployee = employees.filter(e=>e.id===id);
    if(!newEmployee){
        return employees;
    }
...
/*!*****************************!*\
  !*** ./employees/ui-dev.js ***!
  \*****************************/
/*! exports provided: addEmployeeUI, removeEmployeeUI, selectView, runUI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "removeEmployeeUI", function() { return _ui__WEBPACK_IMPORTED_MODULE_0__["removeEmployeeUI"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "selectView", function() { return _ui__WEBPACK_IMPORTED_MODULE_0__["selectView"]; });
...
/*!*************************!*\
  !*** ./employees/ui.js ***!
  \*************************/
/*! exports provided: runUI, addEmployeeUI, removeEmployeeUI, selectView */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _model_Employee__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/Employee */ "./employees/model/Employee.js");
...
/* harmony import */ var _server__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./server */ "./employees/server.js");
...
async function showEmployees(employeesJSON) {
    ...
    let employees = Object(_model_Employee__WEBPACK_IMPORTED_MODULE_2__["jsonToEmployees"])(employeesJSON);
    let allEmployees = await _server__WEBPACK_IMPORTED_MODULE_4__["getEmployees"]();
...
async function runUI(){
    showEmployees(/*currentEmployees*/await _server__WEBPACK_IMPORTED_MODULE_4__["getEmployees"]());
...
async function addEmployeeUI() {
    ...
    let employee = await _server__WEBPACK_IMPORTED_MODULE_4__["addEmployee"](name, surname);
    //const id = addEmployee(name, surname);
    const managerId = document.getElementById("managerSelect").value;
    //setEmployeeManager(id, managerId);
    await _server__WEBPACK_IMPORTED_MODULE_4__["setEmployeeManager"](employee.id, managerId);
...
async function removeEmployeeUI(id) {
    //currentEmployees=removeEmployee(currentEmployees,id);
    await _server__WEBPACK_IMPORTED_MODULE_4__["removeEmployee"](id);
    showEmployees(/*currentEmployees*/await _server__WEBPACK_IMPORTED_MODULE_4__["getEmployees"]());
}
...
async function getEmployeesOptions() {
    let employees = await _server__WEBPACK_IMPORTED_MODULE_4__["getEmployees"]();
...
/* harmony import */ var _employees_employees_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./employees/employees-json */ "./employees/employees-json.js");
...
window.currentEmployees=_employees_employees_json__WEBPACK_IMPORTED_MODULE_3__["default"].employees;
window.removeEmployeeUI = _employees_ui_all__WEBPACK_IMPORTED_MODULE_0__["removeEmployeeUI"];
